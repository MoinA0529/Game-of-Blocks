...
// You can edit this contract as much as you want. A template is provided here and you can change the function names and implement anything else you want, but the basic tasks mentioned here should be accomplished.
    ...
    function viewDues(address user) public view isOwner returns(uint256) {
        return loans[user];
    }
    // Since viewDues inherits from isOwner, only the owner can viewDues
    ...
    // Since this function inherits from isOwner, only the owner settle the dues
}
